<template>
  <vs-row class="w-full" justify="center" style="height: 100%;">
    <vs-col w="10" class="p-6 h-full border-solid" justify="center" align="center" style="border-style: solid;">
      <VxCard
        class="mt-6 p-4 px-8 card"
      >
     
        <div class="p-6">
          <h1 class="title">SIGN IN</h1>
                <vs-alert v-if="errorMessage" danger>Error : {{errorMessage}}</vs-alert>
   <vs-button @click="LoginGoogle()" color="rgb(162,161,166)" type="filled" class="google"><i class="bx bxl-google"></i>Sign in with google</vs-button>
          <vs-input
            v-model="email"
            label="Email"
            color="primary"
        ...
        <vs-col justify="space-between" class="mt-8 justify-end">
          ...
          <button
            ...
            class="signup"
            >Dont have an account yet?<br><span style="color:#6b3deb">Sign Up</span>.
          </button>
...
<style scoped>
  ...
  .google {
    margin-top:0.5vw;background:#DB4437;margin-bottom:2vw;color:#f4f7f8;font-family:ginger-normal;font-size:0.8vw;
  }

  .google i {
font-size:2vw;padding-right:0.5vw;
  }

.login {
  width:60%;font-family:ginger-normal;font-size:0.8vw;border-radius:2vw;
}
.signup {
  width:60%;font-family:ginger-normal;font-size:1vw;border-radius:2vw;margin-top:2vw;
}
  ...
  .google {
    margin-top:1vw;font-size:2.5vw;
  }
  .google i {
font-size:4vw;padding-right:1vw;
  }
  .login {
  width:60%;font-size:2.5vw;border-radius:5vw;
}
.signup {
  width:60%;font-size:2.5vw;margin-top:2vw;
}
   }
  ...
  .google i {
font-size:6vw;padding-right:1vw;
  }
  .login {
  font-size:3vw;
}
