...
export default class VsComponent extends Vue {
  ...
  componentColor: string | null = null
  ...
  changeColor() {
    ...
    if (this.color || this.componentColor) {
      setColor('color', this.componentColor || this.color || 'primary', this.$el as HTMLElement, true)

      if (this.$refs.options) {
        setColor('color', this.componentColor || this.color || 'primary', this.$refs.options as HTMLElement, true)
      }

      if (this.$refs.tooltip) {
        setColor('color', this.componentColor || this.color || 'primary', this.$refs.tooltip as HTMLElement, true)
      }
    }
